...
void GPolyLineTest::Init()
{
	...
	prjHelper.AddCtrl(1, "GPolyLineControl", "win1.tc1", [&prjHelper](void* param) {
		Project::GPolyLineConfig* cfg = (Project::GPolyLineConfig*)param;
		...
		cfg->Mode = 1;	//0:折线 1:多边形
		cfg->LineStyle.Color = 255;
		cfg->LineStyle.Weight = 0;
		cfg->LineStyle.Type = 0;

		cfg->Arrow.HaveStartArrow = true;
		cfg->Arrow.StartArrowType = Project::ArrowType::Arrow;
		cfg->Arrow.StartArrowSize = 14;

		cfg->Arrow.HaveEndArrow = true;
		cfg->Arrow.EndArrowType = Project::ArrowType::Arrow;
		cfg->Arrow.EndArrowSize = 14;

		cfg->IsFill = true;
		cfg->FillColor = 0xff00ff00;

		Project::Point Point1 = { 265,118 };
		cfg->Points.push_back(Point1);
		Project::Point Point2 = { 418,247 };
		cfg->Points.push_back(Point2);
		Project::Point Point3 = { 235,377 };
		cfg->Points.push_back(Point3);
		Project::Point Point4 = { 254,347 };
		cfg->Points.push_back(Point4);
...
bool GPolyLineTest::Run(int argc, char ** argv)
{
	Core::HmiCore core;
	Init();
	core.TestRun(&prj);
